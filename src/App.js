...
import { Challenge as ChallengeScrollEffect } from '/pages/3-scroll-effect/Challenge'
import { Solution as SolutionScrollEffect } from '/pages/3-scroll-effect/Solution'
...
export default function App({ config, path }) {
  ...
  if (path === '/3-scroll-effect') return <ChallengeScrollEffect />
  if (path === '/3-scroll-effect-solution') return <SolutionScrollEffect />
}
